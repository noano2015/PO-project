...
public class Menu extends pt.tecnico.uilib.menus.Menu {
    ...
    public Menu(hva.Hotel receiver) {
        super(Label.TITLE, //
                ...
                new DoShowAllHabitatsWithOutTrees(receiver),
                new DoShowAllUnvaccinatedAnimals(receiver),
                new DoShowAllEmployeesWithoutResponsabilities(receiver),
                new DoShowAllHabitatsWithoutAnimals(receiver)
        );
    }
